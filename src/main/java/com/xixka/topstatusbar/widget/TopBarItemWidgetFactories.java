 ...
 * branch, …) are intentionally NOT listed here: the native menu already has
 * an entry for each of them, and registering a second one would make the
 * entry appear doubled.
 */
